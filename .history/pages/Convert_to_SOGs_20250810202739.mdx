...
* **Run the conversion command.** Use the following command to convert your file, replacing `your-file.ply` with the name of your file and `output-directory/` with the desired location for your converted files.
    ...
    <div>
      <small>
        In the command above: <code className="text-sky-500 font-semibold">your-file.ply</code> is your input file, and <code className="text-emerald-500 font-semibold">output-directory/your-file.meta.json</code> is the output path.
      </small>
    </div>

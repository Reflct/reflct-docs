...
Once the installation is complete, you are ready to convert your **PLY** files. The process is straightforward and can be completed with a single command. We recommend creating a new folder for the output as the conversion will create several new files.
...
* **Run the conversion command.** Use the following command to convert your file, replacing `your-file.ply` with the name of your file and `output-directory/` with the desired location for your converted files.
    ```bash
    splat-transform your-file.ply output-directory/meta.json
    ```
